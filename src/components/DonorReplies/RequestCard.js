    ...
    return (
      <div>
        ...
        /> */}
          ...
          <p class="card-text ngo-request-card-text mb-5">
            <span style={{ fontWeight: "bold" }}>Donation Quantity:</span>{" "}
            &nbsp;{" "}
            {`${checkProperty("Quantity", this.props, 1)} ${checkProperty(
              "Unit",
              this.props,
              "unit"
            )}`}
        ...
        {this.state.addModalShow && (
          ...
          >
                ...
                <table className="table">
                  <tbody>
                    <tr>
                      ...
                      <td>
                        {moment(this.props.PostedDateTime).format(
                          "LL hh:mm:ss"
                        )}
                      </td>
                    </tr>
            ...
            <Modal.Footer>
              <Button variant="#4A89DC" onClick={() => this.addModalClose()}>
                Close
              </Button>
              <Button
                variant="success"
