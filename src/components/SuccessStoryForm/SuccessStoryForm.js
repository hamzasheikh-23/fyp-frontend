        ...
        <div className={this.props.bgclass}>
          <div className="container" id="container">
            ...
            <form
              ...
              onSubmit={this.SuccessStoryFormSubmitHandler}
              noValidate
            >
              <div className="form-group">
                <label htmlFor="storytitle" className="my-story-label">
                  Title:
                </label>
                <input
                  size="lg"
                  ...
                  onChange={(event) =>
                    this.SuccessStoryFormInputChange(event, "storytitle")
                  }
                  id="storytitle"
                ...
                >
                  {this.state.storytitleError}
                </div>
              </div>

              <div className="form-group">
                <label htmlFor="story-description" className="my-story-label">
                  Description:
                </label>
                ...
                <textarea
                  ...
                  onChange={(event) =>
                    this.SuccessStoryFormInputChange(event, "storyDescription")
                  }
                ...
                >
                  {this.state.storyDescriptionError}
                </div>
              </div>

              <div className="form-group">
                <div className="previewComponent">
                  <label htmlFor="story-image" className="my-story-label">
                    Cover Image:
                  </label>
                  <input
                    className="fileInput"
