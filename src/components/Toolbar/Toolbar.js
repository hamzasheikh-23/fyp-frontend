...
<li>
                    ...
                    <li><Link to="/viewStory">NGOs Stories</Link></li> */}
</>
: null }
...
: null }
               ...
               {(localStorage.getItem('loginToken') || localStorage.getItem('admin'))? <li><Link to="/" onClick={logout}>Logout</Link></li> :   <li><Link to="/login">Login</Link></li>}
