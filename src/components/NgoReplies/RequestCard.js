...
class RequestCard extends React.Component {
  ...
  acceptReply=()=>{
    axios.put(`https://localhost:44357/reply/edit?id=${this.props.ReplyId}&status=Approved`)
    .then(res=>{this.props.fetchData()})
    .catch(console.log)
  }
    ...
    return (
      <div>
        <div class="card-body ngo-request-card-body">
          ...
          <h5 class="card-title ngo-request-card-title">{this.props.DonationTitle}</h5>
