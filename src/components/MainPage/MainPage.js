          ...
          <div className="display-pic">
            ...
            <div className="fade-content">
              ...
              <p className="color-highlight">
                " <i>Contribute to make the world a better place </i> "
              </p>
              <hr />
              <p>
                "CharitAble" is built with love and care for all you who believe
                that giving to those in need will bring more joy than money
                could ever buy.
              </p>
              {/* <a href="/">Next</a> */}
              <Link to="/login">
