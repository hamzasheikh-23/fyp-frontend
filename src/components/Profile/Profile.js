...
class Profile extends React.Component{
  componentDidMount(){
    axios.get(`/api/getDonatedItems/${localStorage.getItem('loginId')}`, )
            .then(res=>{
    ...
    state = {
      ...
      deleteItem=(item)=>{
        ...
        axios.delete(`/api/deleteDonatedItem/${item}`)
        .then(res=>{
          axios.get(`/api/getDonatedItems/${localStorage.getItem('loginId')}`, )
            .then(res=>{
              this.setState({items:[...res.data]})
                ...
                <div className="container item-card-container">
                  ...
                  {/*   
                    <Card 
                        ...
                        status="Approved"/>
                    <Card 
                        itemImg1={'https://is2.ecplaza.com/ecplaza2/products/a/a3/a38/429255138/4168030.jpg'} 
                        title='Category – Toys' 
                        ...
                        status="Rejected"/>
                    <Card 
                        itemImg1={'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcRyqRR2FZl7ucIzMQKufDnTTZYmuctJ-djGKw&usqp=CAU'} 
