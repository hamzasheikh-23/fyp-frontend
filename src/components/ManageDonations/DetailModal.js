      ...
      <Modal.Body>
        <div className="container">
            <div className="col-lg-4 col-md-6 col-sm-12">
                {this.props.image===null? null : <img src={this.props.image} height="200px" width="100%" style={{objectFit:'contain', marginBottom:'5px'}} />}
              </div>
            <table className="table">
              ...
              <tr>
                ...
                <td>{`${checkProperty('quantity', data)} ${checkProperty('unit', data)}`} </td>
              </tr>
              <tr>
                <td>Description:</td>
